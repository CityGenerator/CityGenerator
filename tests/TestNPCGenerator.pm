...
subtest 'test create_npc' => sub {
    ...
    subtest 'test create_npc profession' => sub {
        ...
        $npc=NPCGenerator::create_npc({'seed'=>'1', 'race'=>'elf', 'allowed_professions'=>['cobbler','priest']});
    ...
    subtest 'test create_npc attitudes' => sub {
        ...
        $npc=NPCGenerator::create_npc({'seed'=>1, 'primary_attitude'=>'Anger', 'secondary_attitude'=>'Rage', 'ternary_attitude'=>'Hostility'});
