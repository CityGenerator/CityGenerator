...
subtest 'Test World Sky Summary' => sub {
    my $astro=AstronomyGenerator::create_astronomy({seed=>1, 'starsystem_roll'=>1, 'moons_roll'=>1, 'celestial_roll'=>1});
    my $world=WorldGenerator::create_world({seed=>1,'astronomy'=>$astro});
    ...
    $astro=AstronomyGenerator::create_astronomy({seed=>1, 'starsystem_roll'=>1, 'moons_roll'=>31, 'celestial_roll'=>31});
    ...
    $astro=AstronomyGenerator::create_astronomy({seed=>1, 'starsystem_roll'=>71, 'moons_roll'=>71, 'celestial_roll'=>61});
    $world=WorldGenerator::create_world({seed=>1,'astronomy'=>$astro});
    $summary=WorldFormatter::printSkySummary($world);
    is($summary,
    ...
    $astro=AstronomyGenerator::create_astronomy({seed=>1, 'starsystem_roll'=>97, 'moons_roll'=>96, 'celestial_roll'=>93});
    $world=WorldGenerator::create_world({seed=>1,'astronomy'=>$astro});
    $summary=WorldFormatter::printSkySummary($world);
    is($summary, 
