...
subtest 'test create' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 12345 } );
    is( $world->{'seed'}, 12345 );
    is( $world->{'name'}, 'Jupon' );

    $world = WorldGenerator::create( { 'seed' => 12345, 'name' => 'test' } );
    is( $world->{'seed'}, 12345 );
    is( $world->{'name'}, 'test' );
...
subtest 'test generate_atmosphere' => sub {
    my $world;
    $world = WorldGenerator::create( { 'seed' => 765373, 'atmosphere' => { 'reason_roll' => 1 } } );
    is( $world->{'atmosphere'}->{'color'},  "blue" );
    is( $world->{'atmosphere'}->{'reason'}, "water vapor" );
    $world = WorldGenerator::create( { 'seed' => 765373, 'atmosphere' => { 'reason_roll' => 90 } } );
    is( $world->{'atmosphere'}->{'color'},  "blue" );
...
subtest 'test generate_basetemp' => sub {
    my $world;
    $world = WorldGenerator::create( { 'seed' => 765373 } );
...
subtest 'test generate_year' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765373, 'year_roll' => 1 } );
...
subtest 'test generate_day' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765373, 'day_roll' => 1 } );
    is( $world->{'day_roll'}, "1" );
    is( $world->{'day'},      "10" );
...
subtest 'test generate_plates' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765373, 'plates_roll' => 1 } );
...
subtest 'test generate_surface' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765373, 'surface_roll' => 1 } );
    ...
    $world = WorldGenerator::create( { 'seed' => 765373, 'surface' => 100000 } );
    is( $world->{'surface_roll'}, "62" );
...
subtest 'test generate_surfacewater' => sub {
    my $world;
    $world = WorldGenerator::create( { 'seed' => 765379 } );
    is( $world->{'seed'},                     765379 );
    is( $world->{'surfacewater_percent'},     '20' );
    is( $world->{'surfacewater_description'}, 'rare' );

    $world = WorldGenerator::create( { 'seed' => 765379, 'smallstorms_percent' => 1 } );
    is( $world->{'seed'},                    765379 );
...
subtest 'test generate_freshwater' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765379, 'freshwater_percent' => 1 } );
    is( $world->{'seed'},                   765379 );
...
subtest 'test generate_civilization' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765379, 'civilization_percent' => 1 } );
    is( $world->{'seed'},                     765379 );
...
subtest 'test generate_precipitation' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765379, 'precipitation_percent' => 90 } );
    is( $world->{'seed'},                      765379 );
...
subtest 'test generate_clouds' => sub {
    ...
    $world = WorldGenerator::create( { 'seed' => 765379, 'clouds_percent' => 1 } );
    is( $world->{'seed'},               765379 );
